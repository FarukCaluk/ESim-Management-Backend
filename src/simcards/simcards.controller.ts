...
export class SimCardsController {
  ...
  @Put(':id')
  update(@Param('id') id: string, @Body() updateSimCardDto: CreateSimCardDto) {
    return this.simCardsService.update(id, updateSimCardDto);
  }

  @Delete(':id')
  remove(@Param('id') id: string) {
    return this.simCardsService.remove(id);
  }
}
